...
public class StaticBoard extends Board {
     ...
     * Splits up the board in x number of parts, each handled by a seperate thread, which results in a nextBoard array which are copied to the currentBoard and later drawn with draw()
